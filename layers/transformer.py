...
class EncoderWrapper(nn.Module):
    ...
    def __init__(
            self, word_embed_size, n_layers, n_head, d_k, d_v,
            d_model, d_inner, pad_idx = 0, dropout=0.1, n_position=200):

        super().__init__()

        self.position_enc = PositionalEncoding(word_embed_size, n_position=n_position)
    ...
    def forward(self, source_WORD_encoding, src_mask, return_attns=False):
        PAD_ID = 0
        ...
        enc_output = self.dropout(self.position_enc(enc_input))
